(function (root) {
  ...
  */
  ...
  function SHA256_Hash_Byte_Block(H, w) {
    ...
    // The block cipher
    var sha256js = {
      HMAC_SHA256_MAC: HMAC_SHA256_MAC
  };


  // node.js
  if (typeof exports !== 'undefined') {
      module.exports = sha256js

  // RequireJS/AMD
  // http://www.requirejs.org/docs/api.html
  // https://github.com/amdjs/amdjs-api/wiki/AMD
  } else if (typeof(define) === 'function' && define.amd) {
      define([], function() { return sha256js; });

  // Web Browsers
  } else {

      // If there was an existing library at "sha256js" make sure it's still available
      if (root.sha256js) {
          sha256js._sha256js = root.sha256js;
      }

      root.sha256js = sha256js;
  }
